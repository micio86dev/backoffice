...
/**
 * Analytics consent (C13, task 5.6).
 *
 ...
 *
 * It stands down on the participants and login routes. Analytics never runs
 * there anyway, and a cookie dialog floating over somebody's scored evaluation
 * — or over a credential form — is the wrong thing in the wrong place.
 *
...
import { isAnalyticsSafeRoute } from '~/utils/analytics-path'
...
const visible = computed(() => {
  ...
  // Never on the participants branch or the login page. Analytics does not run
  // there, and a cookie dialog over a candidate's scored evaluation — or over a
  // credential form — is the wrong thing in the wrong place.
