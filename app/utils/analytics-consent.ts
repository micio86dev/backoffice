 ...
 *
 * The same module as the candidate app's, and duplicated rather than shared:
 * these are separate deployments on separate origins, so they do not share a
 * localStorage anyway. An operator's consent and a candidate's are different
